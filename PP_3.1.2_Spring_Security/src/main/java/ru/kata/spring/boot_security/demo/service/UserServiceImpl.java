...
public class UserServiceImpl implements UserService {
    ...
    @Override
    @Transactional
    public UserDetails searchByUsername(String username) throws UsernameNotFoundException {
        return userDao.searchByUsername(username);
    }

    @Override
    @Transactional
    public User searchByUsernameOfUser(String username) throws UsernameNotFoundException {
        return userDao.searchByUsernameOfUser(username);
    }
